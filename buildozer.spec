...
requirements = hostpython3==3.7.5,python3==3.7.5,kivy==master,git+https://github.com/HeaTTheatR/KivyMD.git@d4d805103f39c9db97f783842d80415c614c057d,requests,pysocks,hurry.filesize,ago,urllib3,chardet,idna,sdl2_ttf==2.0.15,Pillow
